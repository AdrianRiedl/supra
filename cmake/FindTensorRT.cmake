# FROM https://github.com/NVIDIA/tensorrt-laboratory/blob/master/cmake/FindTensorRT.cmake
# ( https://github.com/NVIDIA/tensorrt-laboratory/commit/7226a146dbfbcda5b870ccc6d3fbc64a03b2fe2d )
...
if(NOT TensorRTONNX_LIBRARY)
    foreach(search ${_TensorRT_SEARCHES})
        find_library(TensorRTONNX_LIBRARY NAMES nvonnxparser ${${search}} PATH_SUFFIXES lib)
    endforeach()
endif()
...
if(TensorRT_FOUND)
    ...
    if(NOT TensorRT_LIBRARIES)
        set(TensorRT_LIBRARIES ${TensorRT_LIBRARY} ${TensorRTONNX_LIBRARY})
    endif()
    ...
    if(NOT TARGET TensorRT::ONNXParser)
        ...
        set_target_properties(TensorRT::ONNXParser PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${TensorRT_INCLUDE_DIRS}")
        set_property(TARGET TensorRT::ONNXParser APPEND PROPERTY IMPORTED_LOCATION "${TensorRTONNX_LIBRARY}")
    endif()
endif()
