...
namespace supra {
    ...
    public:
        ...
        {
            ResultType beamformedXY = sampleBeamform3D<interpolateRFlines, RFType, ResultType, LocationType>(
                    txParams,
                    RF,
                    elementLayout,
                    numReceivedChannels,
            ...
            ResultType beamformedYX = sampleBeamform3DYX<interpolateRFlines, RFType, ResultType, LocationType>(
                    txParams,
                    RF,
                    elementLayout,
                    numReceivedChannels,
