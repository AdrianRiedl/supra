...
#ifndef __TENSORRTNODE_H__
#define __TENSORRTNODE_H__
...
namespace supra
{
	class TensorRtNode : public AbstractNode {
	public:
		TensorRtNode(tbb::flow::graph& graph, const std::string & nodeID, bool queueing);
	...
	private:
		...
		std::mutex m_mutex;
		std::shared_ptr<TensorRtInference> m_torchModule;
